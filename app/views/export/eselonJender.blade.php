...
<body>
	<table class="table table-bordered" id="all">
		<thead>
			<tr>
				<td colspan="34"><strong>{{$title}}</strong></td>
			</tr>
			<tr>
				<td colspan="34"><strong>DI LINGKUNGAN PEMERINTAH KOTA PAYAKUMBUH</strong></td>
			</tr>
			<tr>
				<td colspan="34"><strong>PROPINSI SUMATERA BARAT</strong></td>
			</tr>
			<tr>
				<th rowspan="4">No.</th>
