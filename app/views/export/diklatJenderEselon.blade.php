...
<body>
	<table class="table table-bordered" id="all">
		<thead>
			<tr>
				<td colspan="35"><strong>{{$title}}</strong></td>
			</tr>
			<tr>
				<td colspan="35"><strong>DI LINGKUNGAN PEMERINTAH KOTA PAYAKUMBUH</strong></td>
			</tr>
			<tr>
				<td colspan="35"><strong>PROPINSI SUMATERA BARAT</strong></td>
			</tr>
			<tr>
				<th rowspan="3">No.</th>
