...
<div class="col-lg-12">
	<div class="row">
		<div class="col-lg-4">
			{{ Form::open(array('url' => url('data/instansi/cari'), 'role' => 'form', 'method' => 'get')) }}
		...
		<div class="col-lg-12">
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						<td>{{(($instansi->getCurrentPage()-1)*20)+$key+1}}</td>
						<td>{{$value->nama}}</td>
						<td align="right">
			...
			{{$instansi->appends(array('keyword' => (isset($keyword))?$keyword:''))->links()}}
		</div>
	</div>
</div>
