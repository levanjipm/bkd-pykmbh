...
class LaporanEslJFUController extends \PykmbhBaseController {

	public function jender()
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN JENDER";
		$query = "SELECT 	S.nama,
				(SELECT COUNT(*)
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN DIKLAT STRUKTURAL";
		$query = "SELECT 	S.nama,
				(SELECT COUNT(*)
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN DIKLAT STRUKTURAL PER JENDER";
		$query = "SELECT 	S.nama,
				(SELECT COUNT(*)
				 FROM v_pns_skpd_diklat_jk_esljfu
				 WHERE v_pns_skpd_diklat_jk_esljfu.skpdId = S.id
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN GOLONGAN PER UNIT KERJA";
		$query = "SELECT 	S.nama,
					(SELECT COUNT(*)
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN GOLONGAN RUANG DAN JENDER";
		$query = "SELECT 	S.nama,
					(SELECT COUNT(*)
					 FROM v_pns_skpd_gol_jk_esljfu
					 WHERE v_pns_skpd_gol_jk_esljfu.skpdId = S.id
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN PENDIDIKAN PER UNIT KERJA";
		$query = "SELECT 	S.nama,
				(SELECT COUNT(*)
				 FROM v_pns_skpd_pddk_jk_esljfu 
				 WHERE v_pns_skpd_pddk_jk_esljfu.skpdId = S.id
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN PENDIDIKAN PER JENDER";
		$query = "SELECT 	S.nama,
					(SELECT COUNT(*)
					 FROM v_pns_skpd_pddk_jk_esljfu 
					 WHERE v_pns_skpd_pddk_jk_esljfu.skpdId = S.id
	...
	{
		$title = "REKAPITULASI JUMLAH PNS JABATAN STRUKTURAL DAN JFU BERDASARKAN ";
		$query = "SELECT 	S.nama,
				(SELECT COUNT(*)
