...
class PNSDataController extends \PykmbhBaseController {
	...
	public function diklat($id)
	{
		...
		{
			$success = DB::table('pykmbh_pns_diklat')->insert(array('pnsId' => $id, 'diklatId' => Input::get('diklat'), 'tahun' => Input::get('tahun') ));
	...
	public function instansiKerja($id)
	{
		...
		{
			$success = DB::table('pykmbh_instansi_kerja')->insert(array('pnsId' => $id, 'instansiId' => Input::get('instansi'), 'TMT' => Input::get('tmt') ));
	...
	public function instansiInduk($id)
	{
		...
		{
			$success = DB::table('pykmbh_instansi_induk')->insert(array('pnsId' => $id, 'instansiId' => Input::get('instansi'), 'TMT' => Input::get('tmt') ));
	...
	public function struktural($id)
	{
		...
		{
			DB::table('pykmbh_pns_struktural')->where('pnsId', $id)->update(array('aktif' => 0 ));
			
			$success = DB::table('pykmbh_pns_struktural')->insert(array('pnsId' => $id, 'pnsSkpdId' => $id, 'TMT' => Input::get('tmt'), 'skpdStrukturalId' => Input::get('struktural') ));
